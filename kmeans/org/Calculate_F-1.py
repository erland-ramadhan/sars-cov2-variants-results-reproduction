...
calculated_cluster = np.load('new_no_feature_selection_Labels_kmeans.npy')

orig_df = pd.read_csv('new_no_feature_selection_int_true_variants_k_5.csv', header=None)
